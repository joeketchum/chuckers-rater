...
var $author$project$Config$supabaseConfig = {anonKey: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Ind4bmZmYnphZ2F1amdjd2pyamNrIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjA0ODk5NjcsImV4cCI6MjA3NjA2NTk2N30.zO1-TOroZWdugJaSBFgNjIqr5z3lA-nHHwOp3r6dBsQ', url: 'https://wxnffbzagaujgcwjrjck.supabase.co'};
...
var $author$project$Elo$draw = F2(
	function (kFactor, _v0) {
		...
		return {
			playerA: $elm$core$Basics$round(playerA + aChange),
			playerB: $elm$core$Basics$round(playerB + bChange)
		};
	});
...
var $author$project$Elo$win = F2(
	function (kFactor, _v0) {
		...
		return {
			lost: $elm$core$Basics$round(lost + loseChange),
			won: $elm$core$Basics$round(won + winChange)
		};
	});
...
var $author$project$Main$hasOpenPopup = function (model) {
	return model.showAddPlayerPopup || model.showCustomMatchup;
};
															...
															[
																...
																_List_fromArray(
																	[
																		...
																		_Utils_ap(
																			message,
																			model.autoSaveInProgress ? ' (Voting disabled - autoSave)' : (model.isSyncing ? ' (Voting disabled - syncing)' : '')))
																	])),
																A2(
																$rtfeldman$elm_css$Html$Styled$button,
																_List_fromArray(
